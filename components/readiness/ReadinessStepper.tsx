...
/**
 * The 6-step top-of-journey progress bar for Entity and Market Readiness,
 * adapted from components/incidents/IncidentStepper.tsx (kept as a separate
 * component rather than a shared import so this journey's step count/labels
 * can evolve independently). All 6 steps are built, so there is no lock
 * mechanism here.
 */
export default function ReadinessStepper({ currentStep, onSelect, disabled = false }: ReadinessStepperProps) {
  return (
