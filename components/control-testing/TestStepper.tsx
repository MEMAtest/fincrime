...
/**
 * The 5-step top-of-journey progress bar for Control Testing, adapted from
 * components/change-lab/ChangeStepper.tsx (kept as a separate component
 * rather than a shared import so this journey's step count/labels can evolve
 * independently). All 5 steps are built, so there is no lock mechanism here.
 */
export default function TestStepper({ currentStep, onSelect, disabled = false }: TestStepperProps) {
  return (
