...
interface ResponseStepperProps {
...
/**
 * The 6-step top-of-journey progress bar for the Regulatory Response
 * Workspace, adapted from components/readiness/ReadinessStepper.tsx (kept as
 * a separate component rather than a shared import so this journey's step
 * count/labels can evolve independently). All 6 steps are built, so there is
 * no lock mechanism here.
 */
export default function ResponseStepper({ currentStep, onSelect, disabled = false }: ResponseStepperProps) {
  return (
