...
/**
 * The 7-step top-of-journey progress bar for the Control Change Lab, adapted
 * from components/pra/AssessmentStepper.tsx (kept as a separate component
 * rather than a shared import so the two journeys' step counts/labels can
 * evolve independently). All 7 steps are built; the lock mechanism
 * (LAST_UNLOCKED_STEP) stays for consistency with the PRA pattern.
 */
export default function ChangeStepper({ currentStep, onSelect, disabled = false }: ChangeStepperProps) {
  return (
