...
const ENFORCEMENT_ACTIONS: EnforcementAction[] = [
  ...
  },
  {
    ...
    year: 2024,
    fine: "£16.7m",
    summary: "Screening failures — inadequate screening of customers against sanctions lists and failure to remediate known gaps.",
    controlAreas: ["sanctions_evasion"],
    preventedBy: [
      "Automated sanctions screening with full list coverage",
      "Regular gap analysis and remediation tracking",
      "Independent assurance over screening controls",
      "Timely escalation of screening failures to MLRO",
    ],
  },
];
